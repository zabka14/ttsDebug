if(typename _this == "ARRAY") exitwith
	...
	if(_workers >= maxfacworkers)exitwith{player groupchat "ouvriers d'usine max atteint!"};
	if(_geld < facworkercost)exitwith{player groupchat "Vous n'avez pas asser d'argent"};
...
player groupchat " %4 est maintenant disponible dans l'une de vos usines!";
