...
if (!_holster) then
{
	...
	holsterRifle = player addAction ["Cacher Arme","rifleControl.sqf",[true]];
...
} else
{
	...
	unholsterRifle = player addAction ["Sortir Arme","rifleControl.sqf",[false]];
