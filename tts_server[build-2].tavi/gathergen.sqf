...
if(_type == "Man")then{titletext ["Recolte en cours...", "PLAIN DOWN", 0.1]};
if(_type == "Ship")then{titletext ["Peche en cours...", "PLAIN DOWN", 0.1]};
if(_type == "Tractor")then{titletext ["Recolte en cours...", "PLAIN DOWN", 0.1]};
...
if ([_item, _anzahl] call INV_AddInvItem) then 
	...
	if(_anzahl == 0)exitwith{player groupchat "Les magasins sont pleins de cet article";};
