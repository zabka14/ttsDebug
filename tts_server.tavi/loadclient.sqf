//Request & Load Stats
//Author: {ZAG}Ed!
server globalChat format["SKY-NET Syncing. Please wait...", loadRewardBonus];
hint "SKY-NET Syncing. Please wait.";
...
while {count(loadcontent) == 0} do {
	...
	//server globalChat "If your stats have not loaded please relog.";
	loadtimeout = false;
