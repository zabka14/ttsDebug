...
_CopOnlyShops = [copair,copcar,cgvehshop,cgairshop2,cgboatshop,copcar1,copbasic,coppatrol,copsheriff,copswat,copbasic2,copbasic3,copbasic4,copboatshop,tdoc,copk9cars,coptrafficcars,coptraffic,coptraffic2,coptraffic3,coptraffic4,copvicecars,copswatcars,copsub,copair1,cgweapons,cgboatshop];
...
if(_shop in _VIPcop and !((getPlayerUID player) in donatorlevel4) and (_PlayerTeam == "CIV")) exitwith {player groupchat "Get out of here, you're not a donator!"; closedialog 0};
...
if(_shop in _ADMIN and !((getPlayerUID player) in adminlevel4)) exitwith {player groupchat "You are not Admin GTFO!"; closedialog 0};
