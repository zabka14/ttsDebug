if (!((getPlayerUID player) in policeslots) && (playerSide == west)) exitwith 
{
	progressLoadingScreen 1;endLoadingScreen;
	hintc "VOTRE ID N'EST PAS ADMIS DANS LA POLICE. \nVous allez être Kické du serveur.\nIllusion-Gaming.fr";
