...
if(_art == "buydog" and !(_uid in allowedwar) and isciv) exitWith { player groupChat "Seulement pour les admins"};

if (_geld <= dog_cost)    exitWith {role groupChat "Vous n'avez pas asser d'argent";};
