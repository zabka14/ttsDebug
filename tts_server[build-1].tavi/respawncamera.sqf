...
if(suicided and !iscop)then{titletext[format["Parce que vous suicidé et votre temps de réapparition a augmenté de %1 secondes.", suicidepenalty], "plain"]};
...
while {_deadtime > time} do
	...
	titletext [format["%1 secondes restantes", round(_deadtime - time)], "plain"];
