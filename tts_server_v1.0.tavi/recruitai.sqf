...
if(_geld < MGcost)exitwith{player groupchat "pas assez d'argent"};
...
player groupchat "Le Kord MG est maintenant occupée et pleinement opérationnel!"; 
...
if(_geld < MGcost)exitwith{player groupchat "Pas asser d'argent"};
...
if(_geld < PKcost)exitwith{player groupchat "Pas asser d'argent"};
...
player groupchat "Le PK est maintenant occupée et pleinement opérationnel"; 
